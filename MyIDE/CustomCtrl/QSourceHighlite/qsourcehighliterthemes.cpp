...
static QHash<QSourceHighliter::Token, QTextCharFormat> light()
{
    ...
    _formats[QSourceHighliter::Token::CodeBlock].setForeground(QColor(32, 32, 32));
    _formats[QSourceHighliter::Token::CodeKeyWord].setForeground(QColor(254, 38, 38));
    _formats[QSourceHighliter::Token::CodeString].setForeground(QColor(220, 204, 60));
    _formats[QSourceHighliter::Token::CodeComment].setForeground(QColor(130, 124, 80));
    _formats[QSourceHighliter::Token::CodeType].setForeground(QColor(102, 217, 239));
    _formats[QSourceHighliter::Token::CodeOther].setForeground(QColor(249, 38, 114));
    _formats[QSourceHighliter::Token::CodeNumLiteral].setForeground(QColor(174, 129, 255));
    _formats[QSourceHighliter::Token::CodeBuiltIn].setForeground(QColor(135, 187, 26));
...
QHash<QSourceHighliter::Token, QTextCharFormat>
    ...
    case QSourceHighliter::Themes::Monokai:
        return monokai();
    case QSourceHighliter::Themes::Light:
        return light();
    }
}
